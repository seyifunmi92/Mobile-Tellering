...
class MobileTellerFund {
  ...
  factory MobileTellerFund.fromJson(Map<String, dynamic> json) => MobileTellerFund(
...
class MobileTellerRequest {
  ...
  factory MobileTellerRequest.fromJson(Map<String, dynamic> json) => MobileTellerRequest(
    id: json["id"],
    loginUserId: json["loginUserId"],
    requestedamount: json["requestedamount"],
...
class FundMobileTeller {
  ...
  factory FundMobileTeller.fromJson(Map<String, dynamic> json) => FundMobileTeller(
    loginUserId: json["loginUserId"],
...
class MobileTellerCollection {
  ...
  factory MobileTellerCollection.fromJson(Map<String, dynamic> json) => MobileTellerCollection(
    loginuserid: json["loginuserid"],
...
class MobileTellerLiquidation {
  ...
  factory MobileTellerLiquidation.fromJson(Map<String, dynamic> json) => MobileTellerLiquidation(
    loginuserid: json["loginuserid"],
    isOcode: json["isOcode"],
    transactionreference: json["transactionreference"],
    trandate: DateTime.parse(json["trandate"]),
...
class MobileTellerRequestList {
  ...
  factory MobileTellerRequestList.fromJson(Map<String, dynamic> json) => MobileTellerRequestList(
    id: json["id"],
    loginUserId: json["loginUserId"],
    requestedamount: json["requestedamount"],
    createdate: DateTime.parse(json["createdate"]),
